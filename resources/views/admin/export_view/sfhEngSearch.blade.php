...
<div class="app-content">
    <div class="card mb-4">
        <div class="card-header">
            <h3 class="card-title">SFH Engineering Data</h3>
        </div> 
            ...
            <div class="table-responsive">
                <table id="sfhEng" class="table table-striped">
                    ...
                    <tbody>
                        @if($sfhEng->isEmpty())
                        <tr>
                            <td colspan="12" style="text-align: center;">No records found. Please enter search criteria.</td>
                        </tr>
                        @else
...
<script>
    function downloadSearchDataCSV() {
        ...
        saveAs(blob, "SFH_Eng_Search.csv");
    }
</script>
